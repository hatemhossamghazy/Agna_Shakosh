...
setOrders(data.orders || []);
                ...
                <div className="p-6 bg-gray-50/50 border-b border-gray-100 flex flex-wrap justify-between items-center gap-4">
                  <div className="flex gap-8">
                    <div>
                      ...
                      <span className="font-black text-[#1e2d3e]">{`${order.order_type}-${order.order_id}`}</span>
                    </div>
  ...
  className="bg-[#1e2d3e] text-white px-8 py-3 rounded-xl font-black text-sm hover:bg-[#d35400] transition-all shadow-lg active:scale-95 flex items-center gap-2"
>
