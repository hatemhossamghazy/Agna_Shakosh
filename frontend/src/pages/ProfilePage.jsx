...
/>
            ...
            <h2 className="font-black text-[#1e2d3e] text-lg">{userData?.fname} {userData?.lname}</h2>
            ...
            {activeTab === 'my-tools' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center border-b-2 border-gray-50 pb-4">
                  ...
                  <button onClick={() => navigate('/upload-equipment')} className="bg-[#d35400] text-white font-black px-4 py-2 rounded-xl flex items-center gap-2 hover:bg-[#1e2d3e] transition-all text-sm">
                    ...
                    <div key={pay.id} className="bg-gradient-to-br from-[#1e2d3e] to-[#34495e] p-6 rounded-[2rem] text-white shadow-2xl relative overflow-hidden group">
                      <div className="relative z-10">
                        ...
                        <div className="flex justify-between items-end">
                          <div><p className="text-[10px] text-gray-400 font-black mb-1">Card Holder</p><p className="font-black text-sm">{userData?.fname} {userData?.lname}</p></div>
