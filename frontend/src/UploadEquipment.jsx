...
import { 
  ...
  Package, ArrowRight, Gavel, Wrench
} from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto py-10 px-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm">
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-10 text-center hover:bg-orange-50 transition-all cursor-pointer">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm grid md:grid-cols-2 gap-4">
            <div className="col-span-full">
              ...
              <input 
                ...
                placeholder="مثلاً: صاروخ بوش 4 بوصة"
                className="w-full p-3 bg-gray-50 border rounded-xl outline-none focus:border-[#d35400] font-bold"
              />
            </div>
            ...
            <div className="col-span-full">
              <label className="block mb-2 font-black text-sm text-gray-600">وصف الحالة</label>
              <textarea 
                name="description" rows="3" onChange={handleChange}
                placeholder="اشرح حالة العدة وأي تفاصيل تانية..."
                className="w-full p-3 bg-gray-50 border rounded-xl outline-none focus:border-[#d35400] font-bold"
              ></textarea>
            </div>
          </div>
          ...
          <button 
            type="submit"
            className="w-full bg-[#1e2d3e] text-white py-4 rounded-xl font-black text-lg hover:bg-[#d35400] transition-all shadow-md active:scale-[0.98]"
          >
            إرسال طلب الرفع
          </button>
        </form>
      </div>
      {/* 🟢 الفوتر (النسخة المطلوبة بالظبط) */}
