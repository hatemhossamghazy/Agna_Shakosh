...
module.exports = (db) => {
    ...
    router.post("/register", async (req, res) => {
        try {
            const { fullName, mobileNumber, userType, password, confirmPassword, email, jobType , government, city } = req.body;
...
(fname, lname, email, password, phone, role, government, city)
